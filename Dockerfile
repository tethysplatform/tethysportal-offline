...
COPY --chown=$MAMBA_USER:$MAMBA_USER ./tethys/environment.yml ${TETHYS_HOME}/tethys/
COPY --chown=$MAMBA_USER:$MAMBA_USER ./tethys/micro_environment.yml ${TETHYS_HOME}/tethys/
COPY --chown=$MAMBA_USER:$MAMBA_USER ./tethys/pyproject.toml ${TETHYS_HOME}/tethys/
...
# ADD files from repo
COPY --chown=www:www ./tethys/resources ${TETHYS_HOME}/tethys/resources/
COPY --chown=www:www ./tethys/tethys_apps ${TETHYS_HOME}/tethys/tethys_apps/
COPY --chown=www:www ./tethys/tethys_cli ${TETHYS_HOME}/tethys/tethys_cli/
COPY --chown=www:www ./tethys/tethys_components ${TETHYS_HOME}/tethys/tethys_components/
COPY --chown=www:www ./tethys/tethys_compute ${TETHYS_HOME}/tethys/tethys_compute/
COPY --chown=www:www ./tethys/tethys_config ${TETHYS_HOME}/tethys/tethys_config/
COPY --chown=www:www ./tethys/tethys_layouts ${TETHYS_HOME}/tethys/tethys_layouts/
COPY --chown=www:www ./tethys/tethys_gizmos ${TETHYS_HOME}/tethys/tethys_gizmos/
COPY --chown=www:www ./tethys/tethys_portal ${TETHYS_HOME}/tethys/tethys_portal/
COPY --chown=www:www ./tethys/tethys_quotas ${TETHYS_HOME}/tethys/tethys_quotas/
COPY --chown=www:www ./tethys/tethys_sdk ${TETHYS_HOME}/tethys/tethys_sdk/
COPY --chown=www:www ./tethys/tethys_services ${TETHYS_HOME}/tethys/tethys_services/
COPY --chown=www:www ./tethys/tethys_utils ${TETHYS_HOME}/tethys/tethys_utils/
COPY --chown=www:www ./tethys/tests ${TETHYS_HOME}/tethys/tests/
COPY --chown=www:www ./tethys/README.md ${TETHYS_HOME}/tethys/
...
RUN tethys settings --set STATICFILES_USE_NPM True
